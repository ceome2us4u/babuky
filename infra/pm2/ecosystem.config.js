...
// BABUKI_DEPLOY_DIR on the box. Env vars come from a .env file placed at
// <deploy dir>/.env (never committed — see .env.example), which Next.js
// loads automatically at boot.

const DEPLOY_DIR = process.env.BABUKI_DEPLOY_DIR || "/opt/babuki/current";
